...
const activityStats = [
  { label: "Active Studies", value: "12", icon: FileText, color: "text-teal" },
  { label: "Total Samples", value: "8,934", icon: Activity, color: "text-blue-deep" },
  { label: "Collaborators", value: "47", icon: Users, color: "text-teal" },
  { label: "Analyses Run", value: "156", icon: BarChart3, color: "text-blue-deep" },
];
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <div className="space-y-6 lg:col-span-2">
            ...
            <div className="rounded-xl border border-border bg-card p-6">
              <h2 className="mb-5 text-lg font-semibold text-foreground">Activity Overview</h2>
            ...
            <div className="rounded-xl border border-border bg-card p-6">
              ...
              <div className="flex flex-wrap gap-6 border-t border-border pt-4">
                <div>
                  <p className="mb-1 text-xs text-muted-foreground">ORCID</p>
                  <a
            ...
            <div className="overflow-hidden rounded-xl border border-border bg-card">
              <div className="border-b border-border p-6">
                <h2 className="text-lg font-semibold text-foreground">My Studies</h2>
                <p className="mt-1 text-sm text-muted-foreground">
                  Studies you're leading or contributing to
                </p>
              </div>
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 text-sm text-muted-foreground">
                        ...
                        <span>•</span>
                        <span>{study.samples.toLocaleString()} samples</span>
                      </div>
                    </div>
            ...
            <div className="rounded-xl border border-border bg-card p-6">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <span className="text-sm font-medium text-foreground">Create New Study</span>
                </Link>
                <Link
                  href="/pipelines"
                  className="group flex items-center gap-3 rounded-lg p-3 transition-all hover:bg-muted/50"
                >
                  ...
                  <span className="text-sm font-medium text-foreground">Run Analysis</span>
                </Link>
                <Link
      ...
      <Dialog open={editBioOpen} onOpenChange={setEditBioOpen}>
        <DialogContent className="sm:max-w-[540px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Update your research biography and external links.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-5 py-4">
            <div className="space-y-2">
