...
export default function RegisterPage() {
  ...
  const { register, isLoading: authLoading, isAuthenticated } = useAuthStore();
  ...
  return (
    <>
      ...
      <div className="flex justify-center gap-4">
        <button type="button" className="flex items-center justify-center w-12 h-12 rounded-full border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 hover:bg-slate-50 transition-all" aria-label="Sign up with Google">
        ...
        <button type="button" className="flex items-center justify-center w-12 h-12 rounded-full border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 hover:bg-slate-50 transition-all" aria-label="Sign up with GitHub">
