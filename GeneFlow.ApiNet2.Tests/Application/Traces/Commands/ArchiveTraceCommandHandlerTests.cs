...
/// <summary>
/// Unit tests for ArchiveTraceCommandHandler.
/// </summary>
public class ArchiveTraceCommandHandlerTests
{
    ...
    private readonly ArchiveTraceCommandHandler _handler;

    public ArchiveTraceCommandHandlerTests()
    {
        _unitOfWork.Traces.Returns(_traceRepository);
        _unitOfWork.SaveChangesAsync(Arg.Any<CancellationToken>())
            .Returns(Task.FromResult(1));

        _handler = new ArchiveTraceCommandHandler(_unitOfWork);
    }

    #region Success Cases

    [Fact]
    public async Task Handle_WithProcessedTrace_ShouldArchive()
    {
        // Arrange
        var trace = CreateProcessedTrace();
        var command = new ArchiveTraceCommand("U00000001", trace.Id.ToString());
    ...
    [Fact]
    public async Task Handle_WithUploadedTrace_ShouldArchive()
    {
        // Arrange
    ...
    [Fact]
    public async Task Handle_WithFailedTrace_ShouldArchive()
    {
        // Arrange
    ...
    {
        // Arrange
        var command = new ArchiveTraceCommand("invalid-user-id", Guid.NewGuid().ToString());
    ...
    {
        // Arrange
        var command = new ArchiveTraceCommand("U00000001", "not-a-guid");
    ...
    {
        // Arrange
        var command = new ArchiveTraceCommand("U00000001", Guid.NewGuid().ToString());
    ...
    [Fact]
    public async Task Handle_WithAlreadyArchivedTrace_ShouldFail()
    {
        // Arrange
