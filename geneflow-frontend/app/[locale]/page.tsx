  ...
  const plans = [
    {
      ...
      features: [
        t("pricing.features.freeStudies"),
        t("pricing.features.freeTraces"),
        t("pricing.features.freeMembers"),
      ],
    ...
    },
    {
      ...
      features: [
        t("pricing.features.proStudies"),
        t("pricing.features.proTraces"),
        t("pricing.features.proMembers"),
      ],
    ...
    },
    {
      ...
      features: [
        t("pricing.features.entStudies"),
        t("pricing.features.entTraces"),
        t("pricing.features.entMembers"),
        t("pricing.features.entAI"),
      ],
      cta: t("pricing.getStarted"),
      highlighted: false,
    },
